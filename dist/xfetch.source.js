(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.xfetch = {}));
    ...
    ***************************************************************************** */
    ...
    exports.XFetchContentType = void 0;
    (function (XFetchContentType) {
        ...
        XFetchContentType["form"] = "application/x-www-form-urlencoded;charset=UTF-8";
        XFetchContentType["file"] = "multipart/form-data";
    })(exports.XFetchContentType || (exports.XFetchContentType = {}));
    exports.XFetchHttpMethod = void 0;
    (function (XFetchHttpMethod) {
        ...
        XFetchHttpMethod["delete"] = "DELETE";
        XFetchHttpMethod["options"] = "OPTIONS";
    })(exports.XFetchHttpMethod || (exports.XFetchHttpMethod = {}));
    var CODE_MSG = {
        200: '服务器成功返回请求的数据。',
        201: '新建或修改数据成功。',
    ...
    var XFetchClass = (function () {
        ...
        XFetchClass.prototype.request = function (method, url, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    ...
                    else if (method === exports.XFetchHttpMethod.POST) {
                        contentType = exports.XFetchContentType.FORM;
                    }
                    else {
                        contentType = exports.XFetchContentType.JSON;
                    }
                    ...
                    if (!method || method === exports.XFetchHttpMethod.GET) {
                        fetchConfig = {
                            headers: headers,
                            signal: signal
                        };
                    }
                    else if (method === exports.XFetchHttpMethod.POST && contentType === exports.XFetchContentType.FORM) {
                        bodyData = void 0;
                        ...
                        fetchConfig = {
                            ...
                            headers: headers,
                            signal: signal,
                            method: exports.XFetchHttpMethod.POST
                        };
                    }
                    else {
                        fetchConfig = {
        ...
        XFetchClass.prototype.get = function (url, params, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, this.request(exports.XFetchHttpMethod.GET, url, __assign({ params: params }, config), isWhiteList)];
                });
            });
        };
        XFetchClass.prototype.post = function (url, data, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, this.request(exports.XFetchHttpMethod.POST, url, __assign({ data: data }, config), isWhiteList)];
                });
            });
        };
        XFetchClass.prototype.patch = function (url, data, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, this.request(exports.XFetchHttpMethod.PATCH, url, __assign({ data: data }, config), isWhiteList)];
                });
            });
        };
        XFetchClass.prototype.put = function (url, data, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, this.request(exports.XFetchHttpMethod.PUT, url, __assign({ data: data }, config), isWhiteList)];
                });
            });
        };
        XFetchClass.prototype.delete = function (url, data, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, this.request(exports.XFetchHttpMethod.DELETE, url, __assign({ data: data }, config), isWhiteList)];
                });
            });
        };
        XFetchClass.prototype.postForm = function (url, data, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, this.request(exports.XFetchHttpMethod.POST, url, __assign(__assign({ 'Content-Type': exports.XFetchContentType.FORM }, config), { data: data }), isWhiteList)];
                });
            });
        };
        XFetchClass.prototype.postFile = function (url, files, name, hasBrackets, hasIndex, config, isWhiteList) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2, this.request(exports.XFetchHttpMethod.POST, url, __assign(__assign({ 'Content-Type': exports.XFetchContentType.FILE }, config), { data: formData }), isWhiteList)];
                });
            });
        };
    ...
    exports.XFetchClass = XFetchClass;
